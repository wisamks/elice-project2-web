...
const GoogleLogin = ({ redirect }) => {
    ...
    const link = `https://accounts.google.com/o/oauth2/v2/auth?response_type=code&client_id=${REST_API_KEY}&redirect_uri=${REDIRECT_URI}&scope=${encodedScope}&state=${encodeURIComponent(redirect)}`;
