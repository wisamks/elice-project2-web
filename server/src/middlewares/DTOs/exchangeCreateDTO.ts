...
import { PostSort, PostStatus, Status } from "@_/customTypes/postType";

class ExchangeCreateDTO extends PostCreateDTO {
    @IsNotEmpty({ message: 'sort값은 필수입니다.'})
...
export default ExchangeCreateDTO;